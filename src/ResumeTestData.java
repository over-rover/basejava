...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        /**Заполняем Контакты*/
        r.setContacts(ContactType.PHONE, new Link("+7(921) 855-0482", ""));
        r.setContacts(ContactType.SKYPE, new Link("grigory.kislin", "skype:grigory.kislin"));
        r.setContacts(ContactType.EMAIL, new Link("gkislin@yandex.ru", "gkislin@yandex.ru"));
        r.setContacts(ContactType.LINKEDIN, new Link("", "https://www.linkedin.com/in/gkislin"));
        r.setContacts(ContactType.GITHUB, new Link("", "https://github.com/gkislin"));
        r.setContacts(ContactType.STACKOVERFLOW, new Link("", "https://stackoverflow.com/users/548473"));
        r.setContacts(ContactType.HOMEPAGE, new Link("", "http://gkislin.ru/"));
        ...
        r.setSections(SectionType.OBJECTIVE, new StringDescription(description));


        /**Заполняем секцию Личные качества*/
        description = "Аналитический склад ума, сильная логика, креативность, инициативность. " +
                "Пурист кода и архитектуры.";
        r.setSections(SectionType.PERSONAL, new StringDescription(description));
        ...
        r.setSections(SectionType.ACHIEVEMENT, new ListStringDescription(achievements));
        ...
        r.setSections(SectionType.QUALIFICATIONS, new ListStringDescription(qualifications));

        /**Заполняем секцию Опыт работы*/
        List<ExpEduDescription> exp = new ArrayList<>();

        exp.add(new ExpEduDescription("Java Online Projects", "http://javaops.ru/",
                YearMonth.of(2013, 10), YearMonth.now(),
                "Автор проекта.",
                "Создание, организация и проведение Java онлайн проектов и стажировок."));
        exp.add(new ExpEduDescription("Wrike", "https://www.wrike.com/",
        ...
        exp.add(new ExpEduDescription("RIT Center", "",
        ...
        exp.add(new ExpEduDescription("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/",
        ...
        exp.add(new ExpEduDescription("Yota", "https://www.yota.ru/",
        ...
        exp.add(new ExpEduDescription("Enkata", "http://enkata.com/",
        ...
        exp.add(new ExpEduDescription("Siemens AG", "https://www.siemens.com/ru/ru/home.html",
        ...
        exp.add(new ExpEduDescription("Alcatel", "http://www.alcatel.ru/",
        ...
        List<ExpEduDescription> edu = new ArrayList<>();

        edu.add(new ExpEduDescription("Coursera", "https://www.coursera.org/course/progfun",
                YearMonth.of(2013, 3), YearMonth.of(2013, 5),
                "Functional Programming Principles in Scala\" by Martin Odersky", ""));
        edu.add(new ExpEduDescription("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                YearMonth.of(2011, 3), YearMonth.of(2011, 4),
                "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"", ""));
        edu.add(new ExpEduDescription("Siemens AG", "http://www.siemens.ru/",
                YearMonth.of(2005, 1), YearMonth.of(2005, 4),
                "3 месяца обучения мобильным IN сетям (Берлин)", ""));
        edu.add(new ExpEduDescription("Alcatel", "http://www.alcatel.ru/",
                YearMonth.of(1997, 9), YearMonth.of(1998, 3),
                "6 месяцев обучения цифровым телефонным сетям (Москва)", ""));
        edu.add(new ExpEduDescription("Санкт-Петербургский национальный исследовательский университет " +
        ...
        edu.add(new ExpEduDescription("Заочная физико-техническая школа при МФТИ", "http://www.school.mipt.ru/",
        ...
        for (Map.Entry<ContactType, Link> entry : r.getContacts().entrySet()) {
        ...
        for (Map.Entry<SectionType, AbstractSection> entry : r.getSections().entrySet()) {
            ...
            if (sectionTitle.equals(SectionType.PERSONAL.getTitle()) ||
                ...
                System.out.println(sectionTitle + " " + ((StringDescription) entry.getValue()).getDescription());
                ...
                ListStringDescription sectionContent = (ListStringDescription) entry.getValue();
                for (String element : sectionContent.getDescriptions()) {
                    System.out.println(element);
                }
            } else {
                System.out.println(sectionTitle);
                ExpEduDescription sectionContent = (ExpEduDescription) entry.getValue();
                for (ExpEduDescription element : sectionContent.getDescriptions()) {
                    System.out.println(element);
                }
            }
        }
